                            ...
                            (function () {
                                ...
                                var translateCallback = function translateCallback(myPoiIndex, myGpsIndex, myGps, translatedData) {
                                    ...
                                    if (translatedItems.length === rawLength) {
                                        var overlay_style = function overlay_style(e) {
                                            var p = e.target;
                                        ...
                                        var polyline = new BMap.Polyline([new BMap.Point(116.383752, 39.91334), new BMap.Point(116.38792, 39.920866), new BMap.Point(116.390867, 39.906532)], { strokeColor: 'blue', strokeWeight: 6, strokeOpacity: 0.5 }); //创建折线
