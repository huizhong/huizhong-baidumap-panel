    ...
    return {
        ...
        execute: function () {
            _export("default", {
                 ...
                 */
                gpsToChina: function gpsToChina(wgsLat, wgsLng) {
                 ...
                 */
                chinaToGps: function chinaToGps(gcjLat, gcjLng) {
                 ...
                 */
                chinaToGpsExact: function chinaToGpsExact(gcjLat, gcjLng) {
                    var initDelta = 0.01;
                 ...
                 */
                chinaToBaidu: function chinaToBaidu(gcjLat, gcjLng) {
                    var x = gcjLng,
                        y = gcjLat;
                 ...
                 */
                baiduToChina: function baiduToChina(bdLat, bdLng) {
                    var x = bdLng - 0.0065,
                        y = bdLat - 0.006;
                    var z = Math.sqrt(x * x + y * y) - 0.00002 * Math.sin(y * this.x_pi);
                    var theta = Math.atan2(y, x) - 0.000003 * Math.cos(x * this.x_pi);
                 ...
                 * @return {object}        返回gps经纬度对象
                 */
                baiduToGps: function baiduToGps(bdLat, bdLng) {
                    var china = this.baiduToChina(bdLat, bdLng);
                 ...
                 * @return {object}        返回百度经纬度对象
                 */
                gpsToBaidu: function gpsToBaidu(gpsLat, gpsLng) {
                 ...
                 */
                gpsToMercator: function gpsToMercator(wgsLat, wgsLng) {
                 ...
                 * @return {object}             返回GPS经纬度对象
                 */
                mercatorToGps: function mercatorToGps(mercatorLat, mercatorLng) {
...
//# sourceMappingURL=gps_helper.js.map
